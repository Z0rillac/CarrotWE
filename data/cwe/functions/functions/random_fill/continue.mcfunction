...
execute if score done cwelib.temp matches 1 run tellraw @s ["",{"text":"Filled ","color":"gold"},{"score":{"name":"affectedBlocks","objective":"cwelib.main"},"color":"gold"},{"text":" blocks randomly. ","color":"gold"}]
