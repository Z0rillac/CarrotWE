...
tp @e[type=marker,tag=cwelib.y,limit=1] @e[type=marker,tag=cwelib.x,limit=1]
...
execute as @e[type=marker,tag=cwelib.x,limit=1] at @s run function cwelib:functions/clone/simple/tp_xyz
