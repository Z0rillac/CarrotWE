...
#chat functions
data modify storage cwe:texts root.chat.functions.block_input.fr-fr set value '["",{"text":"Entrée bloc :","color":"gold"},{"text":" "},{"text":"/setblock 29999969 1 15360001 ","underlined":true,"color":"gray","clickEvent":{"action":"suggest_command","value":"/setblock 29999969 1 15360001 "}}]'
data modify storage cwe:texts root.chat.functions.error_deselect.fr-fr set value '["",{"text":"Veuillez rentrer l\'ID d\'une zone :","color":"gold"},{"text":" "},{"text":"/trigger deselect set ...","underlined":true,"color":"gray","clickEvent":{"action":"suggest_command","value":"/trigger deselect set "}}]'
data modify storage cwe:texts root.chat.functions.error_working_in.fr-fr set value '["",{"text":"Veuillez rentrer l\'ID d\'une zone :","color":"gold"},{"text":" "},{"text":"/trigger working_in set ...","underlined":true,"color":"gray","clickEvent":{"action":"suggest_command","value":"/trigger working_in set "}}]'
data modify storage cwe:texts root.chat.functions.error_working_out.fr-fr set value '["",{"text":"Veuillez rentrer l\'ID d\'une zone :","color":"gold"},{"text":" "},{"text":"/trigger working_out set ...","underlined":true,"color":"gray","clickEvent":{"action":"suggest_command","value":"/trigger working_out set "}}]'
data modify storage cwe:texts root.chat.functions.error_working_pool.fr-fr set value '["",{"text":"Veuillez rentrer l\'ID d\'une zone :","color":"gold"},{"text":" "},{"text":"/trigger working_pool set ...","underlined":true,"color":"gray","clickEvent":{"action":"suggest_command","value":"/trigger working_pool set "}}]'
