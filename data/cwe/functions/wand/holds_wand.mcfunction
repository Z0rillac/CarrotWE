...
execute if score @s cwe.selected matches 0 run data modify storage abcl:storage temp.message set value {Message: '["",{"text":"CarrotWE v1.0.0 | Working in: ","color":"gold"},{"score":{"name":"@s","objective":"cwe.working.in"},"color":"green"},{"text":" Working out: ","color":"gold"},{"score":{"name":"@s","objective":"cwe.working.out"},"color":"green"},{"text":" Working pool: ","color":"gold"},{"score":{"name":"@s","objective":"cwe.working.pool"},"color":"green"}]',Priority:2,ClearImmediately:true}
