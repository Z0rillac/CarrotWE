...
function carrotapi:functions/fill/clear/get_pattern
...
function carrotapi:functions/fill/clear/load_x
execute as @e[tag=carrotapi.marker,limit=1] at @s run function carrotapi:functions/fill/clear/xyz
