...
scoreboard players enable @s deselect
scoreboard players enable @s desel
scoreboard players enable @s working
scoreboard players enable @s new_in
scoreboard players enable @s new_out
scoreboard players enable @s new_pool
scoreboard players enable @s working_in
scoreboard players enable @s working_out
scoreboard players enable @s working_pool
scoreboard players enable @s fill
...
scoreboard players set @s deselect 0
scoreboard players set @s desel 0
scoreboard players set @s working 0
scoreboard players set @s new_in 0
scoreboard players set @s new_out 0
scoreboard players set @s new_pool 0
scoreboard players set @s working_in 0
