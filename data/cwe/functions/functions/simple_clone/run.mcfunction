...
execute if score done cwelib.temp matches 1 run tellraw @s ["",{"text":"Cloned ","color":"gold"},{"score":{"name":"affectedBlocks","objective":"cwelib.main"},"color":"gold"},{"text":" blocks.","color":"gold"}]
