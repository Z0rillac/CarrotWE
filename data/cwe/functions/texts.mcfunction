...
#data modify storage cwe:texts root.holds_wand set value '["",{"text":"CarrotWE v1.0.0-beta.1 | Working in: ","color":"gold"},{"score":{"name":"@s","objective":"cwe.working.in"},"color":"green"},{"text":" Working out: ","color":"gold"},{"score":{"name":"@s","objective":"cwe.working.out"},"color":"green"},{"text":" Working pool: ","color":"gold"},{"score":{"name":"@s","objective":"cwe.working.pool"},"color":"green"}]'
