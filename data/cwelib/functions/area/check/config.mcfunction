...
scoreboard players set config.in cwelib.checks 0
...
scoreboard players set config.out cwelib.checks 0
...
execute if score inSizeX cwelib.temp matches ..-1 run scoreboard players operation inSizeX cwelib.temp *= -1 dplib.const
...
execute if score inSizeY cwelib.temp matches ..-1 run scoreboard players operation inSizeY cwelib.temp *= -1 dplib.const
...
execute if score inSizeZ cwelib.temp matches ..-1 run scoreboard players operation inSizeZ cwelib.temp *= -1 dplib.const
...
execute if score outSizeX cwelib.temp matches ..-1 run scoreboard players operation outSizeX cwelib.temp *= -1 dplib.const
...
execute if score outSizeY cwelib.temp matches ..-1 run scoreboard players operation outSizeY cwelib.temp *= -1 dplib.const
...
execute if score outSizeZ cwelib.temp matches ..-1 run scoreboard players operation outSizeZ cwelib.temp *= -1 dplib.const
scoreboard players operation outSizeZ cwelib.temp += 1 dplib.const

scoreboard players operation inSize cwelib.temp = inSizeX cwelib.temp
scoreboard players operation inSize cwelib.temp *= inSizeY cwelib.temp
scoreboard players operation inSize cwelib.temp *= inSizeZ cwelib.temp

scoreboard players operation outSize cwelib.temp = outSizeX cwelib.temp
scoreboard players operation outSize cwelib.temp *= outSizeY cwelib.temp
scoreboard players operation outSize cwelib.temp *= outSizeZ cwelib.temp
execute if score outSize cwelib.temp matches ..-1 run scoreboard players operation outSize cwelib.temp *= -1 dplib.const
