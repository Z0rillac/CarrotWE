...
function cwelib:functions/fill/random/yz
...
execute if score x cwelib.main < outSizeX cwelib.areas positioned ~1 ~ ~ run function cwelib:functions/fill/random/xyz