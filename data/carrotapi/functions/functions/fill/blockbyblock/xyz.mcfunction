...
function carrotapi:functions/fill/blockbyblock/yz
...
execute if score x carrotapi.main < outSizeX carrotapi.areas positioned ~1 ~ ~ run function carrotapi:functions/fill/blockbyblock/xyz