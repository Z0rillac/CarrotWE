...
execute as @e[tag=cwe.area,predicate=cwe:linked_to_head] run function cwe:wand/event/area_editing_refresh/get_coordinates
...
scoreboard players operation search cwe.sid = @s cwe.wand.selected
execute as @e[tag=cwe.area,predicate=cwe:linked_to_head] run function cwe:wand/event/area_editing_refresh/dynamic/set