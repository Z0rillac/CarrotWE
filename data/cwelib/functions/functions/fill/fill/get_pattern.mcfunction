##
 ...
 # Created by Zorillac.
##
scoreboard players operation x cwelib.pattern = outSizeX cwelib.areas
scoreboard players operation y cwelib.pattern = outSizeY cwelib.areas
scoreboard players operation z cwelib.pattern = outSizeZ cwelib.areas
