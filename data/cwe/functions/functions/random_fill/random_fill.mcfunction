...
scoreboard players operation search dplib.sid = @s cwe.working.pool
execute as @e[tag=cwe.area,predicate=dplib:sid/linked_to_head] run function cwe:functions/area/set_coordinates_pool
