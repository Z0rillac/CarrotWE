...
execute if score order.inX cwelib.checks matches 1 if score order.inY cwelib.checks matches 1 if score order.inZ cwelib.checks matches 1 run scoreboard players set order.in cwelib.checks 1 
execute if score order.outX cwelib.checks matches 1 if score order.outY cwelib.checks matches 1 if score order.outZ cwelib.checks matches 1 run scoreboard players set order.out cwelib.checks 1 