...
tp @e[tag=cwelib.out,limit=1] @e[tag=cwelib.z,limit=1]
function cwelib:functions/clone/simple/get_z
function cwelib:functions/clone/simple/buffer/run
execute at @e[tag=cwelib.out,limit=1] run function cwelib:functions/clone/simple/return/run
scoreboard players add z cwelib.main 1

execute as @e[tag=cwelib.z,limit=1] at @s run function cwelib:functions/clone/simple/tp_z
