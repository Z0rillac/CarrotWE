...
data modify storage cwe:texts root.holds_wand set value '["",{"text":"CarrotWE v1.0.0-beta | ","color":"gold"},{"text":"Look Down","color":"green"},{"text":" to open GUI ","color":"gold"},{"text":"Press ","color":"green"},{"keybind":"key.swapOffhand","color":"green"},{"text":" to change selection mod","color":"gold"}]'
